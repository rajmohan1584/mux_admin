...
class SolicitationHelper {
  ...
  static buildSolicitation(BuildContext context, Solicitation sol, [EdgeInsets margin]) {
    ...
    Widget left = Row(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Text(sol.displaySolId, style:TextStyle(fontWeight: FontWeight.bold)),
        )
      ]);
      ...
      right = Row(
        ...
        children: <Widget>[
          Padding(
            ...
            child:Text(sol.blotterStatus, style: TextStyle(fontWeight: FontWeight.bold)),
          ),
          IMAGES.blotterState(sol.blotterStatus)/*
          Image.asset(
  ...
  static Widget solSecurity(String bondTypeDesc, String cusip, String remoteSystem) {
    Widget left = Column(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      crossAxisAlignment: CrossAxisAlignment.start,
      children:[
